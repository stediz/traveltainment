...
/**
 * This class stands for SearchEngineSimpleRegionListRQ StructType
 * @subpackage Structs
 */
class SearchEngineSimpleRegionListRQ extends XmlInterfaceRQ
{
    /**
     * The Search
    ...
    public $Filter;
    /**
     * Constructor method for SearchEngineSimpleRegionListRQ
     * @uses SearchEngineSimpleRegionListRQ::setSearch()
     * @uses SearchEngineSimpleRegionListRQ::setSelection()
     * @uses SearchEngineSimpleRegionListRQ::setFilter()
     ...
     * Set Search value
     * @param \traveltainment\SOAP17\StructType\RegionListSearchType $search
     * @return \traveltainment\SOAP17\StructType\SearchEngineSimpleRegionListRQ
     */
