...
/**
 * This class stands for Booking_Hotel_BookResponse StructType
 * Meta informations extracted from the WSDL
 * - type: tns:Booking_Hotel_BookResponse
 * @subpackage Structs
 */
class Booking_Hotel_BookResponse extends AbstractStructBase
{
    /**
     * The return
     * Meta informations extracted from the WSDL
