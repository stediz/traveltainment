...
/**
 * This class stands for Booking_Package_AvailabilityAndPriceCheck StructType
 * Meta informations extracted from the WSDL
 * - type: tns:Booking_Package_AvailabilityAndPriceCheck
 * @subpackage Structs
 */
class Booking_Package_AvailabilityAndPriceCheck extends AbstractStructBase
{
    /**
     * The request
     * Meta informations extracted from the WSDL
    ...
    public $request;
    /**
     * Constructor method for Booking_Package_AvailabilityAndPriceCheck
     * @uses Booking_Package_AvailabilityAndPriceCheck::setRequest()
     ...
     * Set request value
     * @param \traveltainment\SOAP17\StructType\AvailabilityAndPriceCheckRQ $request
     * @return \traveltainment\SOAP17\StructType\Booking_Package_AvailabilityAndPriceCheck
     */
