...
/**
 * This class stands for GetAvailableOfferDataRQOptionsType StructType
 * @subpackage Structs
 */
class GetAvailableOfferDataRQOptionsType extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for GetAvailableOfferDataRQOptionsType
     * @uses GetAvailableOfferDataRQOptionsType::setAdditionalCurrencies()
     ...
     * @param string $additionalCurrencies
     * @return \traveltainment\SOAP17\StructType\GetAvailableOfferDataRQOptionsType
     */
