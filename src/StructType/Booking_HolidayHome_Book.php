...
/**
 * This class stands for Booking_HolidayHome_Book StructType
 * Meta informations extracted from the WSDL
 * - type: tns:Booking_HolidayHome_Book
 * @subpackage Structs
 */
class Booking_HolidayHome_Book extends AbstractStructBase
{
    /**
     * The request
     * Meta informations extracted from the WSDL
    ...
    public $request;
    /**
     * Constructor method for Booking_HolidayHome_Book
     * @uses Booking_HolidayHome_Book::setRequest()
     ...
     * Set request value
     * @param \traveltainment\SOAP17\StructType\BookRQ $request
     * @return \traveltainment\SOAP17\StructType\Booking_HolidayHome_Book
     */
