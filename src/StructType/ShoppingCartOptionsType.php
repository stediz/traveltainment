...
/**
 * This class stands for ShoppingCartOptionsType StructType
 * @subpackage Structs
 */
class ShoppingCartOptionsType extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for ShoppingCartOptionsType
     * @uses ShoppingCartOptionsType::setAdditionalCurrencies()
