...
/**
 * This class stands for Search_Hotel_OfferListResponse StructType
 * Meta informations extracted from the WSDL
 * - type: tns:Search_Hotel_OfferListResponse
 * @subpackage Structs
 */
class Search_Hotel_OfferListResponse extends AbstractStructBase
{
    /**
     * The return
     * Meta informations extracted from the WSDL
    ...
    public $return;
    /**
     * Constructor method for Search_Hotel_OfferListResponse
     * @uses Search_Hotel_OfferListResponse::setReturn()
     ...
     * Set return value
     * @param \traveltainment\SOAP17\StructType\SearchEngineOfferListRS $return
     * @return \traveltainment\SOAP17\StructType\Search_Hotel_OfferListResponse
     */
