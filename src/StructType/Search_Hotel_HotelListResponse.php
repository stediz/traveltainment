...
/**
 * This class stands for Search_Hotel_HotelListResponse StructType
 * Meta informations extracted from the WSDL
 * - type: tns:Search_Hotel_HotelListResponse
 * @subpackage Structs
 */
class Search_Hotel_HotelListResponse extends AbstractStructBase
{
    /**
     * The return
     * Meta informations extracted from the WSDL
    ...
    public $return;
    /**
     * Constructor method for Search_Hotel_HotelListResponse
     * @uses Search_Hotel_HotelListResponse::setReturn()
     ...
     * Set return value
     * @param \traveltainment\SOAP17\StructType\SearchEngineHotelListRS $return
     * @return \traveltainment\SOAP17\StructType\Search_Hotel_HotelListResponse
     */
