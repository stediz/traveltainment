...
/**
 * This class stands for Search_Flight_SimpleRegionListResponse StructType
 * Meta informations extracted from the WSDL
 * - type: tns:Search_Flight_SimpleRegionListResponse
 * @subpackage Structs
 */
class Search_Flight_SimpleRegionListResponse extends AbstractStructBase
{
    /**
     * The return
     * Meta informations extracted from the WSDL
    ...
    public $return;
    /**
     * Constructor method for Search_Flight_SimpleRegionListResponse
     * @uses Search_Flight_SimpleRegionListResponse::setReturn()
     ...
     * Set return value
     * @param \traveltainment\SOAP17\StructType\SearchEngineSimpleRegionListRS $return
     * @return \traveltainment\SOAP17\StructType\Search_Flight_SimpleRegionListResponse
     */
