...
class HotelReviewSkiOpportunitiesAttributesType extends AbstractStructBase
{
     ...
     * @uses \EnumType\HotelReviewSkiOpportunitiesAttribute::valueIsValid()
     * @uses \EnumType\HotelReviewSkiOpportunitiesAttribute::getValidValues()
     * @throws \InvalidArgumentException
     * @param string[] $skiOpportunitiesAttribute
     * @return \StructType\HotelReviewSkiOpportunitiesAttributesType
     */
    public function setSkiOpportunitiesAttribute(array $skiOpportunitiesAttribute = array())
    {
        ...
        foreach ($skiOpportunitiesAttribute as $hotelReviewSkiOpportunitiesAttributesTypeSkiOpportunitiesAttributeItem) {
            if (!\EnumType\HotelReviewSkiOpportunitiesAttribute::valueIsValid($hotelReviewSkiOpportunitiesAttributesTypeSkiOpportunitiesAttributeItem)) {
                $invalidValues[] = var_export($hotelReviewSkiOpportunitiesAttributesTypeSkiOpportunitiesAttributeItem, true);
            }
        }
        if (!empty($invalidValues)) {
            throw new \InvalidArgumentException(sprintf('Value(s) "%s" is/are invalid, please use one of: %s', implode(', ', $invalidValues), implode(', ', \EnumType\HotelReviewSkiOpportunitiesAttribute::getValidValues())), __LINE__);
        }
