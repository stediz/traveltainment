...
/**
 * This class stands for Search_Flight_CityListResponse StructType
 * Meta informations extracted from the WSDL
 * - type: tns:Search_Flight_CityListResponse
 * @subpackage Structs
 */
class Search_Flight_CityListResponse extends AbstractStructBase
{
    /**
     * The return
     * Meta informations extracted from the WSDL
    ...
    public $return;
    /**
     * Constructor method for Search_Flight_CityListResponse
     * @uses Search_Flight_CityListResponse::setReturn()
     ...
     * Set return value
     * @param \traveltainment\SOAP17\StructType\SearchEngineCityListRS $return
     * @return \traveltainment\SOAP17\StructType\Search_Flight_CityListResponse
     */
