...
/**
 * This class stands for Search_Hotel_SimpleRegionListResponse StructType
 * Meta informations extracted from the WSDL
 * - type: tns:Search_Hotel_SimpleRegionListResponse
 * @subpackage Structs
 */
class Search_Hotel_SimpleRegionListResponse extends AbstractStructBase
{
    /**
     * The return
     * Meta informations extracted from the WSDL
    ...
    public $return;
    /**
     * Constructor method for Search_Hotel_SimpleRegionListResponse
     * @uses Search_Hotel_SimpleRegionListResponse::setReturn()
     ...
     * Set return value
     * @param \traveltainment\SOAP17\StructType\SearchEngineSimpleRegionListRS $return
     * @return \traveltainment\SOAP17\StructType\Search_Hotel_SimpleRegionListResponse
     */
