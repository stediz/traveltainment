...
/**
 * This class stands for Search_Hotel_CityList StructType
 * Meta informations extracted from the WSDL
 * - type: tns:Search_Hotel_CityList
 * @subpackage Structs
 */
class Search_Hotel_CityList extends AbstractStructBase
{
    /**
     * The request
     * Meta informations extracted from the WSDL
    ...
    public $request;
    /**
     * Constructor method for Search_Hotel_CityList
     * @uses Search_Hotel_CityList::setRequest()
     ...
     * Set request value
     * @param \traveltainment\SOAP17\StructType\SearchEngineCityListRQ $request
     * @return \traveltainment\SOAP17\StructType\Search_Hotel_CityList
     */
