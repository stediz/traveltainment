...
/**
 * This class stands for Search_Hotel_CityListResponse StructType
 * Meta informations extracted from the WSDL
 * - type: tns:Search_Hotel_CityListResponse
 * @subpackage Structs
 */
class Search_Hotel_CityListResponse extends AbstractStructBase
{
    /**
     * The return
     * Meta informations extracted from the WSDL
    ...
    public $return;
    /**
     * Constructor method for Search_Hotel_CityListResponse
     * @uses Search_Hotel_CityListResponse::setReturn()
     ...
     * Set return value
     * @param \traveltainment\SOAP17\StructType\SearchEngineCityListRS $return
     * @return \traveltainment\SOAP17\StructType\Search_Hotel_CityListResponse
     */
