...
/**
 * This class stands for GetInsuranceOfferListRQType StructType
 * @subpackage Structs
 */
class GetInsuranceOfferListRQType extends RequestType
{
    /**
     * The SessionID
    ...
    /**
     * Constructor method for GetInsuranceOfferListRQType
     * @uses GetInsuranceOfferListRQType::setSessionID()
     * @uses GetInsuranceOfferListRQType::setProviderID()
     * @uses GetInsuranceOfferListRQType::setAdditionalCurrencies()
