...
/**
 * This class stands for FinalizeBookRS StructType
 * @subpackage Structs
 */
class FinalizeBookRS extends XmlInterfaceRS
{
    /**
     * The Status
    ...
    public $Offer;
    /**
     * Constructor method for FinalizeBookRS
     * @uses FinalizeBookRS::setStatus()
     * @uses FinalizeBookRS::setBookingID()
     * @uses FinalizeBookRS::setShoppingCartID()
     * @uses FinalizeBookRS::setPriceInformation()
     * @uses FinalizeBookRS::setReservationInformation()
     * @uses FinalizeBookRS::setPayment()
     * @uses FinalizeBookRS::setTravellerList()
     * @uses FinalizeBookRS::setCustomer()
     * @uses FinalizeBookRS::setOffer()
     ...
     * Set Status value
     * @param \traveltainment\SOAP17\StructType\StatusType $status
     * @return \traveltainment\SOAP17\StructType\FinalizeBookRS
     */
