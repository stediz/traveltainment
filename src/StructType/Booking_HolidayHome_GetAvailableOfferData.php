...
/**
 * This class stands for Booking_HolidayHome_GetAvailableOfferData StructType
 * Meta informations extracted from the WSDL
 * - type: tns:Booking_HolidayHome_GetAvailableOfferData
 * @subpackage Structs
 */
class Booking_HolidayHome_GetAvailableOfferData extends AbstractStructBase
{
    /**
     * The request
     * Meta informations extracted from the WSDL
    ...
    public $request;
    /**
     * Constructor method for Booking_HolidayHome_GetAvailableOfferData
     * @uses Booking_HolidayHome_GetAvailableOfferData::setRequest()
     ...
     * Set request value
     * @param \traveltainment\SOAP17\StructType\GetAvailableOfferDataRQType $request
     * @return \traveltainment\SOAP17\StructType\Booking_HolidayHome_GetAvailableOfferData
     */
