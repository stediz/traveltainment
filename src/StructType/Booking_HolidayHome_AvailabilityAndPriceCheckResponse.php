...
/**
 * This class stands for Booking_HolidayHome_AvailabilityAndPriceCheckResponse
 * StructType
 * Meta informations extracted from the WSDL
 * - type: tns:Booking_HolidayHome_AvailabilityAndPriceCheckResponse
 * @subpackage Structs
 */
class Booking_HolidayHome_AvailabilityAndPriceCheckResponse extends AbstractStructBase
{
    /**
     * The return
     * Meta informations extracted from the WSDL
