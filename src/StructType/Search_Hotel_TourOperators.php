...
/**
 * This class stands for Search_Hotel_TourOperators StructType
 * Meta informations extracted from the WSDL
 * - type: tns:Search_Hotel_TourOperators
 * @subpackage Structs
 */
class Search_Hotel_TourOperators extends AbstractStructBase
{
    /**
     * The request
     * Meta informations extracted from the WSDL
    ...
    public $request;
    /**
     * Constructor method for Search_Hotel_TourOperators
     * @uses Search_Hotel_TourOperators::setRequest()
     ...
     * Set request value
     * @param \traveltainment\SOAP17\StructType\SearchEngineTourOperatorsRQ $request
     * @return \traveltainment\SOAP17\StructType\Search_Hotel_TourOperators
     */
