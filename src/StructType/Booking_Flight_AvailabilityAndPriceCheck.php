...
/**
 * This class stands for Booking_Flight_AvailabilityAndPriceCheck StructType
 * Meta informations extracted from the WSDL
 * - type: tns:Booking_Flight_AvailabilityAndPriceCheck
 * @subpackage Structs
 */
class Booking_Flight_AvailabilityAndPriceCheck extends AbstractStructBase
{
    /**
     * The request
     * Meta informations extracted from the WSDL
