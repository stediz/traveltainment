...
/**
 * This class stands for Search_Flight_RegionTreeResponse StructType
 * Meta informations extracted from the WSDL
 * - type: tns:Search_Flight_RegionTreeResponse
 * @subpackage Structs
 */
class Search_Flight_RegionTreeResponse extends AbstractStructBase
{
    /**
     * The return
     * Meta informations extracted from the WSDL
    ...
    public $return;
    /**
     * Constructor method for Search_Flight_RegionTreeResponse
     * @uses Search_Flight_RegionTreeResponse::setReturn()
     ...
     * Set return value
     * @param \traveltainment\SOAP17\StructType\SearchEngineRegionTreeRS $return
     * @return \traveltainment\SOAP17\StructType\Search_Flight_RegionTreeResponse
     */
