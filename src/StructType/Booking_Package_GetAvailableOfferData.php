...
/**
 * This class stands for Booking_Package_GetAvailableOfferData StructType
 * Meta informations extracted from the WSDL
 * - type: tns:Booking_Package_GetAvailableOfferData
 * @subpackage Structs
 */
class Booking_Package_GetAvailableOfferData extends AbstractStructBase
{
    /**
     * The request
     * Meta informations extracted from the WSDL
