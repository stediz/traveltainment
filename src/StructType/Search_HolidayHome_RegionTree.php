...
/**
 * This class stands for Search_HolidayHome_RegionTree StructType
 * Meta informations extracted from the WSDL
 * - type: tns:Search_HolidayHome_RegionTree
 * @subpackage Structs
 */
class Search_HolidayHome_RegionTree extends AbstractStructBase
{
    /**
     * The request
     * Meta informations extracted from the WSDL
    ...
    public $request;
    /**
     * Constructor method for Search_HolidayHome_RegionTree
     * @uses Search_HolidayHome_RegionTree::setRequest()
     ...
     * Set request value
     * @param \traveltainment\SOAP17\StructType\SearchEngineRegionTreeRQ $request
     * @return \traveltainment\SOAP17\StructType\Search_HolidayHome_RegionTree
     */
