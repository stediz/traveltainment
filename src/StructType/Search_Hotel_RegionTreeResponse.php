...
/**
 * This class stands for Search_Hotel_RegionTreeResponse StructType
 * Meta informations extracted from the WSDL
 * - type: tns:Search_Hotel_RegionTreeResponse
 * @subpackage Structs
 */
class Search_Hotel_RegionTreeResponse extends AbstractStructBase
{
    /**
     * The return
     * Meta informations extracted from the WSDL
