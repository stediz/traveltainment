...
/**
 * This class stands for Search_Package_OfferList StructType
 * Meta informations extracted from the WSDL
 * - type: tns:Search_Package_OfferList
 * @subpackage Structs
 */
class Search_Package_OfferList extends AbstractStructBase
{
    /**
     * The request
     * Meta informations extracted from the WSDL
    ...
    public $request;
    /**
     * Constructor method for Search_Package_OfferList
     * @uses Search_Package_OfferList::setRequest()
     ...
     * Set request value
     * @param \traveltainment\SOAP17\StructType\SearchEngineOfferListRQ $request
     * @return \traveltainment\SOAP17\StructType\Search_Package_OfferList
     */
