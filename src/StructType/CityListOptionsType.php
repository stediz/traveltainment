...
/**
 * This class stands for CityListOptionsType StructType
 * @subpackage Structs
 */
class CityListOptionsType extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for CityListOptionsType
     * @uses CityListOptionsType::setAdditionalCurrencies()
     ...
     * @param string $additionalCurrencies
     * @return \traveltainment\SOAP17\StructType\CityListOptionsType
     */
