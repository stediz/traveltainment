...
/**
 * This class stands for ReturnDate StructType
 * @subpackage Structs
 */
class ReturnDate extends AbstractStructBase
{
    /**
     * The _
     * @var string
    ...
    public $Weightage;
    /**
     * Constructor method for ReturnDate
     * @uses ReturnDate::set_()
     * @uses ReturnDate::setWeightage()
     * @param string $_
     * @param int $weightage
     */
     ...
     * Set _ value
     * @param string $_
     * @return \traveltainment\SOAP17\StructType\ReturnDate
     */
