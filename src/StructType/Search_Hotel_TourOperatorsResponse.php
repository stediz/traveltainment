...
/**
 * This class stands for Search_Hotel_TourOperatorsResponse StructType
 * Meta informations extracted from the WSDL
 * - type: tns:Search_Hotel_TourOperatorsResponse
 * @subpackage Structs
 */
class Search_Hotel_TourOperatorsResponse extends AbstractStructBase
{
    /**
     * The return
     * Meta informations extracted from the WSDL
    ...
    public $return;
    /**
     * Constructor method for Search_Hotel_TourOperatorsResponse
     * @uses Search_Hotel_TourOperatorsResponse::setReturn()
     ...
     * Set return value
     * @param \traveltainment\SOAP17\StructType\SearchEngineTourOperatorsRS $return
     * @return \traveltainment\SOAP17\StructType\Search_Hotel_TourOperatorsResponse
     */
