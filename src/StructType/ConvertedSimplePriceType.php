...
/**
 * This class stands for ConvertedSimplePriceType StructType
 ...
 * @subpackage Structs
 */
class ConvertedSimplePriceType extends AbstractStructBase
{
    /**
     * The Currency
     * Meta informations extracted from the WSDL
    ...
    public $ExchangeRate;
    /**
     * Constructor method for ConvertedSimplePriceType
     * @uses ConvertedSimplePriceType::setCurrency()
     * @uses ConvertedSimplePriceType::setOriginalCurrency()
     * @uses ConvertedSimplePriceType::set_()
     * @uses ConvertedSimplePriceType::setExchangeRate()
     ...
     * @param string $currency
     * @return \traveltainment\SOAP17\StructType\ConvertedSimplePriceType
     */
