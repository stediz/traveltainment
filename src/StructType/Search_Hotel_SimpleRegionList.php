...
/**
 * This class stands for Search_Hotel_SimpleRegionList StructType
 * Meta informations extracted from the WSDL
 * - type: tns:Search_Hotel_SimpleRegionList
 * @subpackage Structs
 */
class Search_Hotel_SimpleRegionList extends AbstractStructBase
{
    /**
     * The request
     * Meta informations extracted from the WSDL
    ...
    public $request;
    /**
     * Constructor method for Search_Hotel_SimpleRegionList
     * @uses Search_Hotel_SimpleRegionList::setRequest()
     ...
     * Set request value
     * @param \traveltainment\SOAP17\StructType\SearchEngineSimpleRegionListRQ $request
     * @return \traveltainment\SOAP17\StructType\Search_Hotel_SimpleRegionList
     */
