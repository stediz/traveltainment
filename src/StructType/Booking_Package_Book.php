...
/**
 * This class stands for Booking_Package_Book StructType
 * Meta informations extracted from the WSDL
 * - type: tns:Booking_Package_Book
 * @subpackage Structs
 */
class Booking_Package_Book extends AbstractStructBase
{
    /**
     * The request
     * Meta informations extracted from the WSDL
    ...
    public $request;
    /**
     * Constructor method for Booking_Package_Book
     * @uses Booking_Package_Book::setRequest()
     ...
     * Set request value
     * @param \traveltainment\SOAP17\StructType\BookRQ $request
     * @return \traveltainment\SOAP17\StructType\Booking_Package_Book
     */
