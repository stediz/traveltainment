...
/**
 * This class stands for AddonCategoryType EnumType
 * @subpackage Enumerations
 */
class AddonCategoryType
{
    /**
    ...
    /**
     * Constant for value 'OWBooking'
     * @return string 'OWBooking'
     */
    const VALUE_OWBOOKING = 'OWBooking';
    /**
