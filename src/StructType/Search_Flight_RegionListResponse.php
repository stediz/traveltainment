...
/**
 * This class stands for Search_Flight_RegionListResponse StructType
 * Meta informations extracted from the WSDL
 * - type: tns:Search_Flight_RegionListResponse
 * @subpackage Structs
 */
class Search_Flight_RegionListResponse extends AbstractStructBase
{
    /**
     * The return
     * Meta informations extracted from the WSDL
