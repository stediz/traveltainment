...
/**
 * This class stands for Search_Package_TourOperators StructType
 * Meta informations extracted from the WSDL
 * - type: tns:Search_Package_TourOperators
 * @subpackage Structs
 */
class Search_Package_TourOperators extends AbstractStructBase
{
    /**
     * The request
     * Meta informations extracted from the WSDL
    ...
    public $request;
    /**
     * Constructor method for Search_Package_TourOperators
     * @uses Search_Package_TourOperators::setRequest()
     ...
     * Set request value
     * @param \traveltainment\SOAP17\StructType\SearchEngineTourOperatorsRQ $request
     * @return \traveltainment\SOAP17\StructType\Search_Package_TourOperators
     */
