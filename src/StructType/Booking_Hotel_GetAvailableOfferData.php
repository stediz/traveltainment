...
/**
 * This class stands for Booking_Hotel_GetAvailableOfferData StructType
 * Meta informations extracted from the WSDL
 * - type: tns:Booking_Hotel_GetAvailableOfferData
 * @subpackage Structs
 */
class Booking_Hotel_GetAvailableOfferData extends AbstractStructBase
{
    /**
     * The request
     * Meta informations extracted from the WSDL
    ...
    public $request;
    /**
     * Constructor method for Booking_Hotel_GetAvailableOfferData
     * @uses Booking_Hotel_GetAvailableOfferData::setRequest()
     ...
     * Set request value
     * @param \traveltainment\SOAP17\StructType\GetAvailableOfferDataRQType $request
     * @return \traveltainment\SOAP17\StructType\Booking_Hotel_GetAvailableOfferData
     */
